...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=returnsense,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning(f"Could not initialize Cloud Trace/Logging telemetry: {e}. Skipping telemetry setup.")
